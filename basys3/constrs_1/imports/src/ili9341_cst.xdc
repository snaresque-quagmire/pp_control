...
#disable output delay timing checks
set_false_path -to [get_ports -filter {DIRECTION == OUT && NAME != "clk"}]
#disable input delay timing checks
...
##LED
        ...
        set_property  PACKAGE_PIN E19 [get_ports {btn_led[1]}]
            set_property  IOSTANDARD LVCMOS33  [get_ports {btn_led[1]}]
        set_property  PACKAGE_PIN U19 [get_ports {btn_led[2]}]
            set_property  IOSTANDARD LVCMOS33  [get_ports {btn_led[2]}]
        set_property  PACKAGE_PIN V19 [get_ports {btn_led[3]}]
            set_property  IOSTANDARD LVCMOS33  [get_ports {btn_led[3]}]
        set_property  PACKAGE_PIN W18 [get_ports {btn_led[4]}]
            set_property  IOSTANDARD LVCMOS33  [get_ports {btn_led[4]}]
        set_property  PACKAGE_PIN U15 [get_ports {btn_led[5]}]
            set_property  IOSTANDARD LVCMOS33  [get_ports {btn_led[5]}]
        set_property  PACKAGE_PIN U14 [get_ports {btn_led[6]}]
            set_property  IOSTANDARD LVCMOS33  [get_ports {btn_led[6]}]
        set_property  PACKAGE_PIN V14 [get_ports {btn_led[7]}]
            set_property  IOSTANDARD LVCMOS33  [get_ports {btn_led[7]}]
        set_property  PACKAGE_PIN V13 [get_ports {btn_led[8]}]
            set_property  IOSTANDARD LVCMOS33  [get_ports {btn_led[8]}]
        set_property  PACKAGE_PIN V3  [get_ports {btn_led[9]}]
            set_property  IOSTANDARD LVCMOS33  [get_ports {btn_led[9]}]
        set_property  PACKAGE_PIN W3  [get_ports {btn_led[10]}]
            set_property  IOSTANDARD LVCMOS33  [get_ports {btn_led[10]}]
        set_property  PACKAGE_PIN U3  [get_ports {btn_led[11]}]
            set_property  IOSTANDARD LVCMOS33  [get_ports {btn_led[11]}]
        set_property  PACKAGE_PIN P3  [get_ports {btn_led[12]}]
            set_property  IOSTANDARD LVCMOS33  [get_ports {btn_led[12]}]
        set_property  PACKAGE_PIN N3  [get_ports {btn_led[13]}]
            set_property  IOSTANDARD LVCMOS33  [get_ports {btn_led[13]}]
        set_property  PACKAGE_PIN P1  [get_ports {btn_led[14]}]
            set_property  IOSTANDARD LVCMOS33  [get_ports {btn_led[14]}]
        set_property  PACKAGE_PIN L1  [get_ports {btn_led[15]}]
            set_property  IOSTANDARD LVCMOS33  [get_ports {btn_led[15]}]
