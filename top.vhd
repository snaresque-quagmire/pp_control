...
--        "- - - - - - - - - -- - - - - - - - - - -"   -- Row 15
    ...
    signal freq_buffer              :   unsigned(13 downto 0)           := (others => '0');
    signal delay_timer_buffer       :   unsigned(13 downto 0)           := (others => '0');
    signal pulse_num_buffer         :   unsigned(13 downto 0)           := (others => '0');
