...
architecture rtl of tft_controller is
    ...
    constant FULL_PAGE_MODE     : std_logic_vector(3 downto 0)      := "0010";
    constant WR_FROM_BUF        : std_logic_vector(3 downto 0)      := "1010";
    ...
    begin
        if rising_edge(clk) then
            ...
            when LOP =>
                ...
                when COMMAND_MODE =>
                   ...
                   when NUMC =>
                    ...
                    when NUM_STAR =>
                        ...
                        delay_timer_buffer  <=  (input_buffer(4) * 1024) - (input_buffer(4) * 24) +  -- 1000 = 1024 - 24
                                                (input_buffer(5) * 128) - (input_buffer(5) * 28) +   -- 100 = 128 - 28
                                                (input_buffer(6) * 8) + (input_buffer(6) * 2) +    -- 10 = 8 + 2
                                                input_buffer(7);
                        pulse_num_buffer    <=  (input_buffer(8) * 1024) - (input_buffer(8) * 24) +  -- 1000 = 1024 - 24
                ...
                when INSERT_MODE =>
                    ...
                    when NUM0 =>
                        ...
                        input_buffer(underline_integer-1) <= 0;
                        draw_state <= DRAW_CHAR;
                        counter <= DRAW_MODE;
                    when others =>
                        null;
            ...
            when FULL_PAGE_MODE =>
                    ...
                    scr_wea     <= "1";
                    scr_addr    <= std_logic_vector(to_unsigned( currentRowNumber_reg * 16 + pixelCounter/16*240 + pixelCounter mod 16  ,17));                    
                    if inPixelData(pixel_in_char_count) = '1' then
                        scr_din <= x"FFFF";
                    else
                        scr_din <= x"0000";
